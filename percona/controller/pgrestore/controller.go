...
// +kubebuilder:rbac:groups=pgv2.agora.com,resources=perconapgrestores,verbs=get;list;watch
// +kubebuilder:rbac:groups=pgv2.agora.com,resources=perconapgrestores/status,verbs=patch;update
